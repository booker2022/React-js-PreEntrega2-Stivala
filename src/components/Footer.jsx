    ...
    <div className="container py-5">
        <div className="row">
            <div className="col-md-6">
                <a href="/" rel="noreferrer" className="mx-1"><img src="/imagenes/facebook.svg" alt="Facebook" width="24"/></a>
                <a href="/" rel="noreferrer" className="mx-1"><img src="/imagenes/instagram.svg" alt="Instagram" width="24"/></a>
                <a href="/" rel="noreferrer" className="mx-1"><img src="/imagenes/twitter.svg" alt="Teitter" width="24"/></a>
                <a href="/" rel="noreferrer" className="mx-1"><img src="/imagenes/youtube.svg" alt="Youtube" width="24"/></a>
            </div>
